    ...
    if (isset($_SESSION)) {
     ...
     if ($_POST && $_POST['label'] == "comment") {
        ...
        if ($checkComment) {
            ...
            $time = $_POST['time'];
            $userId = $_POST['userId'];
            $query20 = 'INSERT INTO btcEditorReply (postId, message, time, userId) VALUES (' . "'" . $postId . "','" . $message. "','" . $time. "','" . $userId . "'" . ")";
        ...
        <div class="row">
            <div class="col-xs-12">
                <ul class="nav nav-tabs">
                   <?php  
                        $query1 = "SELECT B.brandName, count(*) 
                            FROM btcBrand B, btcEditorPost P 
                        ...
                        $tempCount = 0;
                        while ($row1 = mysqli_fetch_row($result1)) { // fetch count of docs for each brand
                            if ($tempCount == 0) {
                ...
                <div class="tab-content">
                    <?php
                        ...
                        foreach ($categoryArray as $value1) {
                            ...
                            $tempQuery1 = "SELECT P.postId, P.subject, P.time,  U.editorName, P.message
                                            FROM btcBrand B, btcEditorPost P, btcEditor U
                                            WHERE B.brandName =" . "'" . $value1 . "' AND B.brandId = P.brandId AND P.editorId = U.editorId ORDER BY P.time DESC";
                            ...
                            while ($tempRow1 = mysqli_fetch_row($tempResult1)) {
                                ...
                                FROM btcEditorReply R, btcUser U
                    ...
                    ?>
                           <!-- Providing the feature of creating comments -->
                                <div id=<?php echo '"' . $tempRow1[0] .  'w"'; ?> class="collapse">
                                    <form class="form-horizontal" action="btcBigBrand.php" method="post" role="form">
