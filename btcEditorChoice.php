        ...
        <div class="row">
            <div class="col-xs-12">
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#mostrecent">Editor's Choice &nbsp </a></li>
                </ul>
                ...
                <div class="tab-content">
                    <?php
                        ...
                        FROM btcCategory C, btcEditorPost P, btcEditor U
                        WHERE C.categoryId = P.categoryId AND P.editorId = U.editorId ORDER BY P.time";
                        ...
                        while ($tempRow1 = mysqli_fetch_row($tempResult1)) {
                            ...
                            while ($tempRow2 = mysqli_fetch_row($tempResult2)) {
                                echo '<tr>';
                                echo "<td> $tempRow2[2] &nbsp &nbsp - By Editor: $tempRow2[0] on $tempRow2[1]</td>";
                                echo '</tr>';
                            }
                ...
                <div class="tab-content">
                    ...
                    ?>
                                ...
                                <div id=<?php echo '"' . $tempRow1[0] .  'w"'; ?> class="collapse">
                                    <form class="form-horizontal" action="btcEditorChoice.php" method="post" role="form">
