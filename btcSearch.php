        ...
        <div class="row">
            <div class="col-xs-12">
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#mostrecent">Search Results &nbsp </a></li>
                </ul>
                ...
                <div class="tab-content">
                    <?php
                        ...
                        WHERE P.message LIKE '%". $search . "%' OR P.subject LIKE '%". $search . "%' ORDER BY P.time DESC LIMIT 10";
                ...
                <div class="tab-content">
                    ...
                    ?>
                                ...
                                <div id=<?php echo '"' . $tempRow1[0] .  'w"'; ?> class="collapse">
                                    <form class="form-horizontal" action="btcSearch.php" method="post" role="form">
